...
<html>
    ...
    <body>
        ...
        <div class="w3-top">
            <div class="w3-bar w3-white w3-card" id="myNavbar">
                ...
                <div class="w3-right w3-hide-small">
                    ...
                    <a href="" class="w3-bar-item w3-button"><i class="fa fa-user-circle"></i> PROFILE</a>
                </div>
            </div>
        </div>
        ...
        <!--Howto Section -->
        <div class="w3-container-about w3-content w3-center w3-padding-64" style="max-width:800px" id="band">
            <h2 class="w3-wide"> HOW TO BOOKING / RENTAL SPACE. </h2>
            <div class="row">
                <div class="column">
                    <h2>STEP 1</h2>
                ...
                <div class="w3-row-padding w3-padding-32" style="margin:0 -16px">
                    <div class="w3-third w3-margin-bottom">
                        ...
                        <div class="w3-container w3-container-up">
                            ...
                            <p>...</p>
                            <button class="w3-button w3-black w3-button w3-margin-bottom" onclick="document.getElementById('ticketModal').style.display = 'block'">..READ MORE..</button>
                        </div>
                    </div>
                    <div class="w3-third w3-margin-bottom">
                    ...
                    <div class="exwrapper">
                        <div class="col13">
                            ...
                            <p>4th Floor<br><br>Opening hours : Everyday<br>10.00 AM - 10.00 PM
                                ...
                                <br><br>SmileDevTeam Office :<br>T : +66 2 690 1000
                            </p></div>
                        <div class="col13">
                            <h2>FOLLOW.</h2>
