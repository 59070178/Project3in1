    ...
    <body>
        ...
        <div class="w3-top">
            <div class="w3-bar w3-white w3-card" id="myNavbar">
                <a href="home_staff.jsp" class="w3-bar-item w3-button w3-wide"><img src="pic/logo.png" width="35" height="30"/> </a>
                <!-- Right-sided navbar links -->
                <div class="w3-right w3-hide-small">

                    <a href="home_staff.jsp" class="w3-bar-item w3-button"><i class="fa fa-home"></i>  HOME</a>
